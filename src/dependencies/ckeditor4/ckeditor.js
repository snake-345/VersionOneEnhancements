...
(function () {
		...
		return {
			...
			once: function () {
				...
				return function (g, n, r) {
					...
					if (e) {
						var v = e.listeners;
						if (v.length) for (var v = v.slice(0), B, D = 0; D < v.length; D++) {
							if (e.errorProof) try {
								B =
									v[D].call(this, r, n, b, k)
							} catch (x) {
							} else B = v[D].call(this, r, n, b, k);
							!1 === B ? h = 1 : "undefined" != typeof B && (n = B);
							if (a || h) break
						}
					}
	...
	(function () {
		var a = [], d = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "",
			b = /&/g, c = />/g, f = /</g, h = /"/g, k = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g,
			g = {lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­"}, n = function (a, e) {
	...
	CKEDITOR.dtd = function () {
		...
		a(d, {
			$block: a({audio: 1, dd: 1, dt: 1, figcaption: 1, li: 1, video: 1}, f, n),
			$blockLimit: {
				article: 1,
				aside: 1,
				audio: 1,
	...
	(function () {
		...
		function d(a, b, c, d, f) {
			...
			function g() {
				...
				b < w - 1 || b < A - 1 || c ? (c ? a.moveToPosition(F,
			...
			if (l && F.type == CKEDITOR.NODE_TEXT && (t.equals(F) || t.type === CKEDITOR.NODE_ELEMENT && t.getFirst().equals(F))) c.append(a.document.createText(F.substring(L, C))); else {
				...
				for (var O = t.getParents(), p = F.getParents(), N = m(),
					     w = O.length - 1, A = p.length - 1, G = c, I, X, V, da = -1, Q = N; Q <= w; Q++) {
					X = O[Q];
					V = X.getNext();
					for (Q != w || X.equals(p[Q]) && w < A ? b && (I = G.append(X.clone(0, f))) : M ? h(X, G, !1, E) : H && G.append(a.document.createText(X.substring(L))); V;) {
						if (V.equals(p[Q])) {
							da = Q;
							break
						}
				...
				G = c;
				for (Q = N; Q <= A; Q++) if (c = p[Q], V = c.getPrevious(), c.equals(O[Q])) b && (G = G.getChild(0)); else {
					Q != A || c.equals(O[Q]) && A < w ? b && (I = G.append(c.clone(0, f))) : q ? h(c, G, !1, z) : P && G.append(a.document.createText(c.substring(0, C)));
		...
		CKEDITOR.dom.range.prototype = {
			clone: function () {
				...
				return {startNode: a ? d + (h ? "C" : "S") : b, endNode: a ? d + "E" : c, serializable: a, collapsed: h}
				...
				switch (a) {
					...
					case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
						...
						if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
							l = this.clone();
							l = new CKEDITOR.dom.walker(l);
							var w = CKEDITOR.dom.walker.whitespaces(), A = CKEDITOR.dom.walker.bookmark();
			...
			fixBlock: function (a, b) {
				...
				return {previousBlock: f, nextBlock: h, wasStartOfBlock: c, wasEndOfBlock: d, elementPath: m}
	...
	(function () {
		function a(a, b, c, d, f) {
			...
			for (e in b) {
				...
				for (m in P) {
					l[m] = k(l[m], p) || null;
					var h = l, t = O[m], q = k(l[O[m]], p), A = l[m], z = [], g = !0, H = void 0;
					q ? g = !1 : q = {};
					for (H in A) "!" == H.charAt(0) && (H = H.slice(1), z.push(H), q[H] = !0, g = !1);
					for (; H = z.pop();) A[H] =
						A["!" + H], delete A["!" + H];
					h[t] = (g ? !1 : q) || null
				}
			...
			for (d = a.length; c < d; ++c) {
				...
				for (m in O) {
					...
					q = [];
					A = void 0;
					for (A in t) -1 < A.indexOf("*") ? q.push(new RegExp("^" + A.replace(/\*/g, ".*") + "$")) : q.push(A);
					t = q;
					t.length && (l[p] = t, h = !1)
				}
				l.nothingRequired = h;
		...
		CKEDITOR.filter.prototype = {
			allow: function (b, c, d) {
				...
				var f = this, e = [], w = this.editor && this.editor.config.protectedSource, p, h = !1,
					t = {doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b};
				a.forEach(function (a) {
					if (a.type == CKEDITOR.NODE_ELEMENT) {
						if ("off" == a.attributes["data-cke-filter"]) return !1;
						if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-")) if (p = B(f, a, e, t), p & 1) h = !0; else if (p & 2) return !1
						...
						a:{
							...
							1 == d.children.length && (l = d.children[0]).type == CKEDITOR.NODE_ELEMENT && B(f, l, c, t);
							c = !c.length
						}
						c || e.push(a)
					}
			...
			addContentForms: function (a) {
				...
				if ("string" == typeof a) {
					...
					f = e(a).$1;
					var l = f.styles, d = f.classes;
					f.name = f.elements;
					f.classes = d = d ? d.split(/\s*,\s*/) : [];
					f.styles = r(l);
					f.attributes = r(f.attributes);
					f.children = [];
				...
				B(this, l, p, {doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c});
				0 < p.length ? c = !1 : ((b = f.attributes["class"]) && (f.attributes["class"] = f.attributes["class"].split(" ").sort().join(" ")), c = CKEDITOR.tools.objectCompare(f.attributes, l.attributes, !0), b && (f.attributes["class"] = b));
				"string" == typeof a && (this._.cachedChecks[w] = c);
				return c
		...
		var P = {styles: 1, attributes: 1, classes: 1},
			...
			N = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, w = /^cke:(object|embed|param)$/,
			A = /^(object|embed|param)$/, G;
			...
			sizeToStyle: function (a) {
				...
				if ("string" == typeof b) a.name = b; else {
					...
					for (e in f) if ("class" == e) for (c =
						                                    a.classes.join("|"), w = f[e].split(/\s+/); p = w.pop();) -1 == c.indexOf(p) && a.classes.push(p); else a.attributes[e] = f[e];
			...
			var h = {}, k = function (b) {
				a.call(this, b, function (a) {
					...
					for (e in a) {
						...
						if (!d[e]) {
							if (g.icons) for (var B = g.icons.split(","), D = B.length; D--;) CKEDITOR.skin.addIcon(B[D], g.path + "icons/" + (CKEDITOR.env.hidpi && g.hidpi ? "hidpi/" : "") + B[D] + ".png");
							d[e] = 1
						}
	...
	(function () {
			...
			CKEDITOR.plugins.load(d.split(","),
				function (b) {
					...
					for (var l in b) {
						...
						t && !a.lang[l] && (t.split && (t = t.split(",")), 0 <= CKEDITOR.tools.indexOf(t, a.langCode) ? k = a.langCode : (k = a.langCode.replace(/-.*/, ""), k = k != a.langCode && 0 <= CKEDITOR.tools.indexOf(t, k) ? k : 0 <= CKEDITOR.tools.indexOf(t,
							"en") ? "en" : t[0]), h.langEntries && h.langEntries[k] ? (a.lang[l] = h.langEntries[k], k = null) : e.push(CKEDITOR.getUrl(h.path + "lang/" + k + ".js")));
						f.push(k);
						d.push(h)
					}
		...
		CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
			plugins: {
				...
				for (var a = this.keystrokeHandler.keystrokes, b = CKEDITOR.tools.isArray(arguments[0]) ? arguments[0] : [[].slice.call(arguments, 0)], c, d, f = b.length; f--;) c = b[f], d = 0, CKEDITOR.tools.isArray(c) && (d = c[1], c = c[0]), d ? a[c] = d : delete a[c]
					...
					if (a(e)) m.push(e); else {
						...
						if ("br" == f) J.push(e); else {
							for (; !(g = (h = u.name) ? CKEDITOR.dtd[h] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, e.isUnknown || u.isUnknown || g[f]);) if (u.isOptionalClose) D.onTagClose(h); else if (f in b && h in b) h = u.children, (h = h[h.length - 1]) && "li" == h.name || y(h = new CKEDITOR.htmlParser.element("li"), u), !e.returnPoint && (e.returnPoint = u), u = h; else if (f in CKEDITOR.dtd.$listItem &&
								!B(f, h)) D.onTagOpen("li" == f ? "ul" : "dl", {}, 0, 1); else if (h in d && !B(f, h)) !e.returnPoint && (e.returnPoint = u), u = u.parent; else if (h in CKEDITOR.dtd.$inline && m.unshift(u), u.parent) y(u, u.parent, 1); else {
								e.isOrphan = 1;
								break
							}
							n(f);
	...
	(function () {
		...
		var m = /(?:&nbsp;|\xa0)$/, J = "{cke_protected}", u = CKEDITOR.dtd,
			...
			u.$block), t = {elements: {input: g, textarea: g}}, F = {
		...
		var M = /<(a|area|img|input|source)\b([^>]*)>/gi,
			...
			O = /(<\/?)((?:object|embed|param|html|body|head|title)([\s][^>]*)?>)/gi,
	...
	(function () {
		...
		CKEDITOR.editable = CKEDITOR.tools.createClass({
			base: CKEDITOR.dom.element, $: function (a, b) {
				...
				focus: function () {
					...
					var c = K, d = {range: a, doc: a.document}, e = this.getHtmlFromRange(a);
					...
					if (!this.is("textarea")) {
						...
						this.attachListener(a, "key", function (b) {
							...
							if (0 !== b.getRanges().length) {
								if (c in
									q) {
									var f, g = b.getRanges()[0], p = g.startPath(), k, w, A, c = 8 == c;
									CKEDITOR.env.ie && 11 > CKEDITOR.env.version && (f = b.getSelectedElement()) || (f = h(b)) ? (a.fire("saveSnapshot"), g.moveToPosition(f, CKEDITOR.POSITION_BEFORE_START), f.remove(), g.select(), a.fire("saveSnapshot"), d = 1) : g.collapsed && ((k = p.block) && (A = k[c ? "getPrevious" : "getNext"](e)) && A.type == CKEDITOR.NODE_ELEMENT && A.is("table") && g[c ? "checkStartOfBlock" : "checkEndOfBlock"]() ? (a.fire("saveSnapshot"), g[c ? "checkEndOfBlock" : "checkStartOfBlock"]() && k.remove(), g["moveToElementEdit" +
		...
		x = function () {
			...
			function b(c, d) {
				...
				e = d.range.startPath();
				for (var z = E[z.getName()], k = 0, H = c.getChildren(), m = H.count(), n = -1, r = -1, C = 0, P = e.contains(E.$list); k < m; ++k) e = H.getItem(k), a(e) ? (g =
					e.getName(), P && g in CKEDITOR.dtd.$list ? h = h.concat(b(e, d)) : (q = !!z[g], "br" != g || !e.data("cke-eol") || k && k != m - 1 || (C = (f = k ? h[k - 1].node : H.getItem(k + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && E.$block[f.getName()]), -1 != n || q || (n = k), q || (r = k), h.push({
					isElement: 1,
					isLineBreak: C,
					...
					name: g,
					allowed: q
				}), f = C = 0)) : h.push({isElement: 0, node: e, allowed: 1});
			...
			function d(b, c) {
				var e = [], f = b.getChildren(), g = f.count(),
					q, h = 0, z = E[c], k = !b.is(E.$inline) || b.is("br");
			...
			function h(b, c, d, e) {
				...
				(g = (new CKEDITOR.dom.walker(f)).next()) && a(g) && z[g.getName()] && (q = g.getPrevious()) && a(q) && !q.getParent().equals(b.startContainer) &&
			...
			return function (z, p, N, w) {
				...
				if (!w.checkReadOnly()) {
					...
					if (!p.collapsed) {
						var A = I.block || I.blockLimit, v = p.getCommonAncestor();
						A && !A.equals(v) && !A.contains(v) && p.checkEndOfBlock() && z.zombies.push(A);
						p.deleteContents()
					}
					...
					n = p.startPath();
					if (A = n.contains(f, !1, 1)) p.splitElement(A), z.inlineStylesRoot = A, z.inlineStylesPeak = n.lastElement;
					n = p.createBookmark();
					(A = n.startNode.getPrevious(c)) && a(A) && f(A) && w.push(A);
					(A = n.startNode.getNext(c)) && a(A) && f(A) && w.push(A);
					for (A = n.startNode; (A = A.getParent()) && f(A);) w.push(A);
					p.moveToBookmark(n);
					if (n = N) {
						n = z.range;
						...
						for (q(p, y); w < p.length; w++) {
							...
							if (u) N = 0 < w; else {
								...
								!I.isBlock && k(z.editor, u.block, u.blockLimit) && (T = g(z.editor)) && (T = n.createElement(T),
									T.appendBogus(), y.insertNode(T), CKEDITOR.env.needsBrFiller && (B = T.getBogus()) && B.remove(), y.moveToPosition(T, CKEDITOR.POSITION_BEFORE_END));
								if ((u = y.startPath().block) && !u.equals(D)) {
									if (B = u.getBogus()) B.remove(), x.push(u);
									D = u
								}
								...
								I.lastNotAllowed && w < p.length - 1 && ((K = v ? G : K) && y.setEndAt(K, CKEDITOR.POSITION_AFTER_START), A = 0);
								y.collapse()
							}
						}
						1 != p.length ? B = !1 : (B = p[0], B = B.isElement && "false" == B.node.getAttribute("contenteditable"));
						B && (N = !0, u = p[0].node, y.setStartAt(u, CKEDITOR.POSITION_BEFORE_START),
					...
					if (K) for (; D = K.pop();) CKEDITOR.env.needsBrFiller ? D.appendBogus() : D.append(B.document.createText(" "));
					...
					function a(c) {
						...
						g.guard = function (a, g) {
							if (a.type == CKEDITOR.NODE_ELEMENT) {
								...
								CKEDITOR.dom.element.setMarker(p, a, A, 1)
							}
							if (g && h && a.equals(h)) f = c.clone(), f.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), e.push(f); else if (!g && k && a.equals(k)) f = c.clone(), f.setStartAt(k, CKEDITOR.POSITION_AFTER_START), e.push(f); else {
								if (A = !g) A = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!h || b(a, h)) && (!k ||
									b(a, k));
								if (!A && (A = g)) if (a.is(d)) var A = h && h.getAscendant("table", !0),
									l = k && k.getAscendant("table", !0), H = a.getAscendant("table", !0),
									A = A && A.contains(H) || l && l.contains(H); else A = void 0;
			...
			c.on("contentDom", function () {
				...
				g.attachListener(g, CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function () {
					n && CKEDITOR.env.webkit && (n = c._.previousActive &&
						c._.previousActive.equals(e.getActive())) && null != c._.previousScrollTop && c._.previousScrollTop != g.$.scrollTop && (g.$.scrollTop = c._.previousScrollTop);
					c.unlockSelection(n);
					n = 0
				}, null, null, -1);
				...
				if (CKEDITOR.env.ie || E) m ? g.attachListener(g, "beforedeactivate", a, null, null, -1) : g.attachListener(c, "selectionCheck", a, null, null, -1), g.attachListener(g, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function () {
					c.lockSelection(r);
					n = 1
				}, null, null, -1), g.attachListener(g, "mousedown",
					function () {
						n = 0
					});
				...
				CKEDITOR.env.ie && g.attachListener(g, "keydown", function (a) {
					var b = this.getSelection(1), c = d(b);
					...
					if (p) this.fake(p); else if (b && b.plugins.tableselection && CKEDITOR.plugins.tableselection.isSupportedEnvironment && d(a) && !l) f.call(this, a); else {
						if (m) {
							...
							for (I = 0; I < a.length; I++) {
								...
								b.collapsed && CKEDITOR.env.webkit && r(b) && (p = e(this.root), b.insertNode(p), (A = p.getNext()) && !p.getPrevious() && A.type == CKEDITOR.NODE_ELEMENT && "br" == A.getName() ? (y(this.root), b.moveToPosition(A, CKEDITOR.POSITION_BEFORE_START)) : b.moveToPosition(p, CKEDITOR.POSITION_AFTER_END));
	...
	(function () {
		...
		function c(a) {
			...
			if (a.collapsed) {
				for (var f = new CKEDITOR.dom.elementPath(d.getParent(), a.root), g, h = 0, k; h < f.elements.length && (k = f.elements[h]) && k != f.block && k != f.blockLimit; h++) if (this.checkElementRemovable(k)) {
					var m;
					!e && a.collapsed && (a.checkBoundaryOfElement(k, CKEDITOR.END) || (m = a.checkBoundaryOfElement(k, CKEDITOR.START))) ? (g = k, g.match = m ? "start" : "end") : (k.mergeSiblings(), k.is(this.element) ? B.call(this, k) : x(k, l(this)[k.getName()]))
				}
				if (g) {
					e = d;
					for (h =
				...
				b();
				for (f = d; !f.equals(n);) g = f.getNextSourceNode(), f.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(f) && (f.getName() == this.element ? B.call(this, f) : x(f, l(this)[f.getName()]), g.type == CKEDITOR.NODE_ELEMENT && g.contains(d) && (b(), g = d.getNext())), f = g
			}
			a.moveToBookmark(c);
		...
		function L(a, b, c) {
			...
			var e, f;
			if (a.isFake && a.isInTable()) for (e = [], f = 0; f < d.length; f++) e.push(d[f].clone());
...
*/
			...
			add: function (a, b) {
				...
				var a = function (a, c) {
					...
					return CKEDITOR.tools.extend({
						...
						"class": "cke_dialog_ui_button_cancel", onClick: function (a) {
							a = a.data.dialog;
	...
	(function () {
		...
		CKEDITOR.ui.button.prototype = {
			render: function (a, b) {
				...
				this._.editor = a;
				var e = {
					id: q, button: this, editor: a, focus: function () {
		...
		function x(a) {
			...
			(function () {
				function b(c, d, e, h, f) {
					...
					a.addCommand(d, e);
					a.ui.addButton && a.ui.addButton(c, {label: n, command: d, toolbar: "clipboard," + h});
					a.addMenuItems && a.addMenuItem(d, {label: n, command: d, group: "clipboard", order: f})
				}
			...
			a.getClipboardData = function (b, c) {
				...
				function e(a) {
					a.removeListener();
					a.cancel();
					c({type: f, dataValue: a.data.dataValue, dataTransfer: a.data.dataTransfer, method: "paste"})
				}
				...
				isRequired: function () {
					...
					try {
						...
						if (this._isUnsupportedMimeTypeError(h)) {
							...
							-1 === CKEDITOR.tools.indexOf(c._customTypes,
			...
			$: function (a, b, c, m) {
				...
				addBlock: function (a, b) {
					...
					var l = this.element, e = this._.iframe,
						...
						t = b.getDocumentPosition(f), f = r ? r.getDocumentPosition(f) : {x: 0, y: 0},
					...
					CKEDITOR.tools.setTimeout(function () {
						var a = CKEDITOR.tools.bind(function () {
							...
							a.setCustomData("activePanel",
								this);
							l.setStyles({top: p + "px", left: d + "px"});
							l.setOpacity(1);
							g && g()
						}, this);
		...
		requires: "panelbutton,floatpanel", init: function (e) {
			function t(a, d, g, r, k) {
				var p = new CKEDITOR.style(l["colorButton_" + d + "Style"]),
					m = CKEDITOR.tools.getNextId() + "_colorBox", q;
				k = k || {};
			...
			function y(a, d, g) {
				a = [];
				var r = l.colorButton_colors.split(","), k = l.colorButton_colorsPerRow || 6,
					p = e.plugins.colordialog && !1 !== l.colorButton_enableMore, m = r.length + (p ? 2 : 1),
			...
			var l = e.config, h = e.lang.colorbutton;
			if (!CKEDITOR.env.hc) {
				...
				if (void 0 === x || x) w.contentTransformations = [[{
					element: "span", left: function (a) {
						...
						var d = (new CKEDITOR.style(e.config.colorButton_backStyle, {color: a.styles.background})).getDefinition();
						a.name = d.element;
						a.styles = d.styles;
	...
	CKEDITOR.plugins.add("menu", {
		requires: "floatpanel", beforeInit: function (l) {
	...
	(function () {
		...
		function q(a) {
			...
			!0 === a.config.copyFormatting_allowRules && (this.filter.disabled =
				!0);
			a.config.copyFormatting_disallowRules && this.filter.disallow(a.config.copyFormatting_disallowRules)
		}

		var l = CKEDITOR.tools.indexOf, r = CKEDITOR.tools.getMouseButton, t = !1;
		CKEDITOR.plugins.add("copyformatting", {
			...
			init: function (a) {
				...
				t || (CKEDITOR.document.appendStyleSheet(this.path + "styles/copyformatting.css"), t = !0);
				a.addContentsCss && a.addContentsCss(this.path +
				...
				a.on("contentDom", function () {
					var d = a.editable(), b = d.isInline() ? d : a.document, c = a.ui.get("CopyFormatting");
					...
					d.attachListener(CKEDITOR.document, "mouseup", function (b) {
						...
						r(b) !== CKEDITOR.MOUSE_BUTTON_LEFT || e.state !== CKEDITOR.TRISTATE_ON || d.contains(b.data.getTarget()) || a.execCommand("copyFormatting")
					});
					c && (b = CKEDITOR.document.getById(c._.id), d.attachListener(b, "dblclick", function () {
		...
		q.prototype._isContextAllowed = function (a) {
			var b =
				this.editor.config.copyFormatting_allowedContexts;
			return !0 === b || -1 !== l(b, a)
		};
		...
		CKEDITOR.plugins.copyformatting = {
			...
			commands: {
				copyFormatting: {
					exec: function (a, b) {
						var d = CKEDITOR.plugins.copyformatting, e = a.copyFormatting,
							c = b ? "keystrokeHandler" == b.from : !1, f = b ? b.sticky || c : !1,
							g = d._getCursorContainer(a), h = CKEDITOR.document.getDocumentElement();
						if (this.state === CKEDITOR.TRISTATE_ON) return e.styles = null, e.sticky = !1, g.removeClass("cke_copyformatting_active"), h.removeClass("cke_copyformatting_disabled"), h.removeClass("cke_copyformatting_tableresize_cursor"),
							d._putScreenReaderMessage(a, "canceled"), d._detachPasteKeystrokeHandler(a), this.setState(CKEDITOR.TRISTATE_OFF);
						e.styles = d._extractStylesFromElement(a, a.elementPath().lastElement);
						...
						e.sticky = f;
						d._putScreenReaderMessage(a, "copied");
						d._attachPasteKeystrokeHandler(a)
					}
				}, applyFormatting: {
					editorFocus: CKEDITOR.env.ie &&
					!CKEDITOR.env.edge ? !1 : !0, exec: function (a, b) {
						var d = a.getCommand("copyFormatting"), e = b ? "keystrokeHandler" == b.from : !1,
							c = CKEDITOR.plugins.copyformatting, f = a.copyFormatting, g = c._getCursorContainer(a),
			...
			_convertElementToStyleDef: function (a) {
				var b = CKEDITOR.tools, d = a.getAttributes(CKEDITOR.plugins.copyformatting.excludedAttributes),
			...
			_extractStylesFromElement: function (a, b) {
				var d = {}, e = [];
				do if (b.type === CKEDITOR.NODE_ELEMENT && !b.hasAttribute("data-cke-bookmark") && (d.element = b, a.copyFormatting.fire("extractFormatting", d, a) && d.styleDef && e.push(new CKEDITOR.style(d.styleDef)), b.getName && -1 !== l(CKEDITOR.plugins.copyformatting.breakOnElements, b.getName()))) break; while ((b = b.getParent()) && b.type === CKEDITOR.NODE_ELEMENT);
				return e
			},
			...
			_removeStylesFromElementInRange: function (a, b) {
				for (var d = -1 !== l(["ol", "ul", "table"], b), e = new CKEDITOR.dom.walker(a), c; c = e.next();) if (c = c.getAscendant(b, !0)) if (c.removeAttributes(c.getAttributes()), d) break
			},
			_getSelectedWordOffset: function (a) {
				...
				function e(a, c) {
					var f = a, g = /\s/g, h = "p br ol ul li td th div caption body".split(" "), m = !1, k = !1, p, n;
					do {
					...
					if (m) c ? n = 0 : (g = /([\.\b]*$)/, n = (k = g.exec(h)) ? k.index : h.length); else if (c && (n += 1, n > h.length)) return e(f);
					return {node: f, offset: n}
				}

				var c = /\b\w+\b/ig, f, g, h, m, k;
				h = m = k = a.startContainer;
				for (f = d(h); null != (g = c.exec(f));) if (g.index + g[0].length >= a.startOffset) return a = g.index, c = g.index + g[0].length, 0 === g.index && (g = e(h, !0), m = g.node, a = g.offset), c >= f.length && (f = e(h), k = f.node, c = f.offset), {
					startNode: m,
					startOffset: a,
					endNode: k,
					endOffset: c
			...
			_determineContext: function (a) {
				function b(b) {
					var e = new CKEDITOR.dom.walker(a), c;
			...
			_applyStylesToTextContext: function (a, b, d) {
				var e = CKEDITOR.plugins.copyformatting, c = e.excludedAttributesFromInlineTransform, f, g;
				CKEDITOR.env.webkit && !CKEDITOR.env.chrome && a.getSelection().selectRanges([b]);
				for (f = 0; f < d.length; f++) if (b = d[f], -1 === l(e.excludedElementsFromInlineTransform, b.element)) {
			...
			_applyStylesToListContext: function (a, b, d) {
				...
				for (f = 0; f < d.length; f++) e = d[f], c = b.createBookmark(), "ol" === e.element || "ul" === e.element ? k(b, {
					...
					b.applyToObject(a)
				}, !0) : "li" === e.element ? k(b, "li", function (a) {
					e.applyToObject(a)
				}) : CKEDITOR.plugins.copyformatting._applyStylesToTextContext(a, b, [e]), b.moveToBookmark(c)
			},
			_applyStylesToTableContext: function (a, b, d) {
				...
				var c, f, g;
				for (g = 0; g < d.length; g++) c = d[g], f = b.createBookmark(), -1 !== l(["table", "tr"], c.element) ? k(b, c.element, function (a) {
					c.applyToObject(a)
				}) : -1 !== l(["td", "th"], c.element) ? k(b, {td: 1, th: 1}, function (a) {
					e(a, c)
				}) : -1 !== l(["thead", "tbody"], c.element) ? k(b, {thead: 1, tbody: 1}, function (a) {
					e(a, c)
			...
			_applyFormat: function (a, b) {
				var d = a.getSelection().getRanges()[0],
					e = CKEDITOR.plugins.copyformatting, c, f;
				if (!d) return !1;
				if (d.collapsed) {
					...
					d.setEnd(c.endNode, c.endOffset);
					d.select()
				}
				b = e._filterStyles(b);
			...
			_putScreenReaderMessage: function (a, b) {
				var d = this._getScreenReaderContainer();
				d && d.setText(a.lang.copyformatting.notification[b])
			},
	...
	(function () {
		function q(a, c) {
			function k(b) {
				...
				CKEDITOR.env.ie && a.fire("selectionChange", {selection: e, path: new CKEDITOR.dom.elementPath(b)});
				a.focus()
			}
	...
	(function () {
		function x(a, e, b) {
			...
			if ("wysiwyg" == a.mode) {
				...
				var g = a.elementPath();
				g && !g.isContextFor("p") && (e = CKEDITOR.ENTER_BR, b = 1);
				a.fire("saveSnapshot");
		...
		CKEDITOR.plugins.enterkey =
			{
				enterBlock: function (a, e, b, g) {
					...
					if (b = b || y(a)) {
						b = z(b);
						var h = b.document, n = b.checkStartOfBlock(), f = b.checkEndOfBlock(),
							p = a.elementPath(b.startContainer), c = p.block, l = e == CKEDITOR.ENTER_DIV ? "div" : "p",
							d;
						if (n && f) {
							if (c && (c.is("li") || c.getParent().is("li"))) {
								...
								d = b.getParent();
								g = !c.hasPrevious();
								var f = !c.hasNext(), l = a.getSelection(), n = l.createBookmarks(),
									k = c.getDirection(1), t = c.getAttribute("class"), q = c.getAttribute("style"),
									r = d.getDirection(1) != k;
								a = a.enterMode != CKEDITOR.ENTER_BR || r || q || t;
								if (d.is("li")) g || f ? (g && f && b.remove(), c[f ? "insertAfter" : "insertBefore"](d)) : c.breakParent(d); else {
									if (a) if (p.block.is("li") ? (d = h.createElement(e == CKEDITOR.ENTER_P ? "p" : "div"), r && d.setAttribute("dir", k), q && d.setAttribute("style", q), t && d.setAttribute("class",
										t), c.moveChildren(d)) : d = p.block, g || f) d[g ? "insertBefore" : "insertAfter"](b); else c.breakParent(b), d.insertAfter(b); else if (c.appendBogus(!0), g || f) for (; h = c[g ? "getFirst" : "getLast"]();) h[g ? "insertBefore" : "insertAfter"](b); else for (c.breakParent(b); h = c.getLast();) h.insertAfter(b);
									c.remove()
								}
								l.selectBookmarks(n);
								return
						...
						if (q = b.splitBlock(l)) {
							...
							n = q.wasStartOfBlock;
							f = q.wasEndOfBlock;
							c ? (k = c.getParent(), k.is("li") && (c.breakParent(k), c.move(c.getNext(), 1))) : a && (k = a.getParent()) && k.is("li") && (a.breakParent(k), k = a.getNext(), b.moveToElementEditStart(k), a.move(a.getPrevious()));
							if (n || f) if (m(e)) b.moveToElementEditStart(b.getTouchedStartNode()); else {
								if (a) {
									if (a.is("li") || !w.test(a.getName()) &&
										!a.is("pre")) d = a.clone()
								} else c && (d = c.clone());
								d ? g && !d.is("li") && d.renameNode(l) : k && k.is("li") ? d = k : (d = h.createElement(l), a && (t = a.getDirection()) && d.setAttribute("dir", t));
								if (h = q.elementPath) for (e = 0, g = h.elements.length; e < g; e++) {
									l = h.elements[e];
									if (l.equals(h.block) || l.equals(h.blockLimit)) break;
									CKEDITOR.dtd.$removeEmpty[l.getName()] && (l = l.clone(), d.moveChildren(l), d.append(l))
								}
								d.appendBogus();
								d.getParent() || b.insertNode(d);
								d.is("li") && d.removeAttribute("value");
								!CKEDITOR.env.ie || !n || f && a.getChildCount() ||
								(b.moveToElementEditStart(f ? a : d), b.select());
								b.moveToElementEditStart(n && !f ? c : d)
							} else c.is("li") && (d = b.clone(), d.selectNodeContents(c), d = new CKEDITOR.dom.walker(d), d.evaluator = function (a) {
								return !(B(a) || A(a) || a.type == CKEDITOR.NODE_ELEMENT && a.getName() in CKEDITOR.dtd.$inline && !(a.getName() in CKEDITOR.dtd.$empty))
							}, (k = d.next()) && k.type == CKEDITOR.NODE_ELEMENT && k.is("ul", "ol") && (CKEDITOR.env.needsBrFiller ? h.createElement("br") : h.createText(" ")).insertBefore(k)), c && b.moveToElementEditStart(c);
							b.select();
							b.scrollIntoView()
						}
					}
					...
					if (b = b || y(a)) {
						var m = b.document, h = b.checkEndOfBlock(),
							n = new CKEDITOR.dom.elementPath(a.getSelection().getStartElement()), f = n.block,
							p = f && n.block.getName();
						g || "li" != p ? (!g && h && w.test(p) ? (h = f.getDirection()) ? (m = m.createElement("div"), m.setAttribute("dir", h), m.insertAfter(f), b.setStart(m, 0)) : (m.createElement("br").insertAfter(f), CKEDITOR.env.gecko && m.createText("").insertAfter(f), b.setStartAt(f.getNext(), CKEDITOR.env.ie ? CKEDITOR.POSITION_BEFORE_START : CKEDITOR.POSITION_AFTER_START)) :
	...
	(function () {
		function p(b, f, e, d, r, p, t, x) {
			var y = b.config, u = new CKEDITOR.style(t), g = r.split(";");
			r = [];
	...
	(function () {
		...
		var v = {ol: 1, ul: 1}, K = CKEDITOR.dom.walker.whitespaces(), H = CKEDITOR.dom.walker.bookmark(),
			u = function (b) {
				return !(K(b) || H(b))
			...
			requires: "clipboard", init: function (a) {
				...
				a.on("paste", function (f) {
					var b = f.data,
						...
						c = c ||
							b.dataValue, g = {dataValue: c, dataTransfer: {"text/rtf": d}},
	...
	(function () {
		var b = {
			readOnly: 1, modes: {wysiwyg: 1, source: 1}, exec: function (a) {
		...
		parseConfig: function (a) {
			...
			if (0 < c.length && "no_any_suggestions" !== c[0]) if (d) for (d =
				...
				d < a.config.scayt_maxSuggestions ? (a.addMenuItem(l, {
					...
					group: "scayt_moresuggest", order: 10, getItems: function () {
						return e
					}
		...
		requires: "dialog", init: function (a) {
			function f(c) {
				return CKEDITOR.tools.extend(c || {}, {
					contextSensitive: 1, refresh: function (c, b) {
			...
			if (!a.blockless) {
				...
				a.ui.addButton && a.ui.addButton("Table", {label: e.toolbar, command: "table", toolbar: "insert,30"});
				...
				a.addMenuItems && a.addMenuItems({
					table: {
						...
						group: "table",
						order: 5
					}, tabledelete: {label: e.deleteTable, command: "tableDelete", group: "table", order: 1}
				});
				a.on("doubleclick", function (a) {
	...
	(function () {
		...
		function z(a, b) {
			var c = a.getAscendant("table"), d = b.getAscendant("table"), e = CKEDITOR.tools.buildTableMap(c), g = r(a),
				h = r(b), k = [], f = {}, l, p;
			c.contains(d) && (b = b.getAscendant({td: 1, th: 1}), h = r(b));
			g > h && (c = g, g = h, h = c, c = a, a = b, b = c);
			for (c = 0; c < e[g].length; c++) if (a.$ === e[g][c]) {
				l = c;
				break
			}
			for (c = 0; c < e[h].length; c++) if (b.$ === e[h][c]) {
				p = c;
				break
			}
			l > p && (c = l, l = p, p = c);
			for (c = g; c <= h; c++) for (g = l; g <= p; g++) d = new CKEDITOR.dom.element(e[c][g]),
		...
		function A(a, b) {
			var c = a.editable().find(".cke_table-faked-selection"), d;
			a.fire("lockSnapshot");
			...
			a.fire("unlockSnapshot");
			b && (m = {active: !1}, a.getSelection().isInTable() && a.getSelection().reset())
		}
		...
		function L(a, b, c) {
			...
			if (e) m.first = b || d[0], m.dirty = b ? !1 : 1 !== d.length; else if (m.active && b && m.first.getAscendant("table").equals(b.getAscendant("table"))) {
				d = z(m.first, b);
		...
		function M(a) {
			var b =
				(a = a.editor || a.sender.editor) && a.getSelection(), c = b && b.getRanges() || [], d;
		...
		function w(a) {
			...
			function d(a, d, e, f) {
				return ("mousedown" !== a.name || CKEDITOR.tools.getMouseButton(a) !== CKEDITOR.MOUSE_BUTTON_LEFT && f) && ("mouseup" !== a.name || c(a.data.getTarget()) || b(e, f)) ? !1 : !0
			}

			if (a.data.getTarget().getName && ("mouseup" === a.name || !D(a.data.getTarget()))) {
				var e = a.editor || a.listenerData.editor,
					g = e.getSelection(1), h = J(e), k = a.data.getTarget(),
					f = k && k.getAscendant({td: 1, th: 1}, !0), k = k && k.getAscendant("table", !0),
					l = {table: 1, thead: 1, tbody: 1, tfoot: 1, tr: 1, td: 1, th: 1};
				d(a, g, h, k) && A(e, !0);
				!m.active && "mousedown" === a.name && CKEDITOR.tools.getMouseButton(a) === CKEDITOR.MOUSE_BUTTON_LEFT && k && (m = {active: !0}, CKEDITOR.document.on("mouseup", w, null, {editor: e}));
				(f || k) && L(e, f || k, a);
				"mouseup" === a.name && (CKEDITOR.tools.getMouseButton(a) === CKEDITOR.MOUSE_BUTTON_LEFT && (c(a.data.getTarget()) || b(h, k)) && K(e), m = {active: !1},
		...
		function O(a, b) {
			...
			var d = a.getSelection(), e = d.createBookmarks(), g = a.document, h = a.createRange(),
				k = g.getDocumentElement().$, f = CKEDITOR.env.ie && 9 > CKEDITOR.env.version,
				l = a.blockless || CKEDITOR.env.ie ? "span" : "div", p, x, n, m;
			g.getById("cke_table_copybin") || (p = g.createElement(l), x = g.createElement(l),
				x.setAttributes({id: "cke_table_copybin", "data-cke-temp": "1"}), p.setStyles({
				position: "absolute",
				width: "1px",
				height: "1px",
				overflow: "hidden"
			}), p.setStyle("ltr" == a.config.contentsLangDirection ? "left" : "right", "-5000px"), p.setHtml(a.getSelectedHtml(!0)), a.fire("lockSnapshot"), x.append(p), a.editable().append(x), m = a.on("selectionChange", c, null, null, 0), f && (n = k.scrollTop), h.selectNodeContents(p), h.select(), f && (k.scrollTop = n), setTimeout(function () {
				x.remove();
				d.selectBookmarks(e);
				m.removeListener();
				a.fire("unlockSnapshot");
		...
		q.prototype.getTableMap = function () {
			var a = C(this.cells.first), b;
			a:{
				b = this.cells.last;
				var c = b.getAscendant("table"), d = r(b), c = CKEDITOR.tools.buildTableMap(c),
					e;
				for (e = 0; e < c[d].length; e++) if ((new CKEDITOR.dom.element(c[d][e])).equals(b)) {
					b = e;
					break a
				}
				b = void 0
		...
		q.prototype.insertRow = function (a, b, c) {
			if ("undefined" === typeof a) a = 1; else if (0 >= a) return;
			for (var d = this.cells.first.$.cellIndex, e = this.cells.last.$.cellIndex, g = c ? [] : this.cells.all, h, k = 0; k < a; k++) h = F(c ? this.cells.all : g, b), h = CKEDITOR.tools.array.filter(h.find("td, th").toArray(),
				function (a) {
		...
		var H = {
			onPaste: function (a) {
				...
				var d = a.editor, e = d.getSelection(), g = v(e),
					h = this.findTableInPastedContent(d, a.data.dataValue),
					k = e.isInTable(!0) && this.isBoundarySelection(e), f, l;
				!g.length || 1 === g.length && !I(e.getRanges()[0]) && !k || k && !h || (g = g[0].getAscendant("table"),
					f = new q(v(e, g)), d.once("afterPaste", function () {
					var a;
					if (l) {
					...
					t(d, a)
				}), h ? (a.stop(), k ? (f.insertRow(1, 1 === k, !0), e.selectElement(f.rows.first)) : (f.emptyCells(), t(d, f.cells.all)), a = f.getTableMap(), l = CKEDITOR.tools.buildTableMap(h), f.insertRow(l.length - a.length), f.insertColumn(b(l) - b(a)), a = f.getTableMap(), this.pasteTable(f, a, l), d.fire("saveSnapshot"), setTimeout(function () {
						d.fire("afterPaste")
					},
				...
				var c = a.dataProcessor, d = new CKEDITOR.dom.element("body");
				...
				var d, e = C(a.cells.first), g = a._getTable(), h = {}, k, f, l, p;
				for (l = 0; l < c.length; l++) for (k = new CKEDITOR.dom.element(g.$.rows[a.rows.first.$.rowIndex + l]), p = 0; p < c[l].length; p++) if (f = new CKEDITOR.dom.element(c[l][p]), d = b[l] && b[l][p] ? new CKEDITOR.dom.element(b[l][p]) : null, f && !f.getCustomData("processed")) {
					if (d && d.getParent()) f.replace(d); else if (0 === p || c[l][p - 1]) (d = 0 !== p ? new CKEDITOR.dom.element(c[l][p -
					1]) : null) && k.equals(d.getParent()) ? f.insertAfter(d) : 0 < e ? k.$.cells[e] ? f.insertAfter(new CKEDITOR.dom.element(k.$.cells[e])) : k.append(f) : k.append(f, !0);
		...
		CKEDITOR.plugins.tableselection = {
			getCellsBetween: z, keyboardIntegration: function (a) {
				function b(a) {
					...
					b && "function" === typeof b.is && b.is({td: 1, th: 1}) ? b.setText("") : a.deleteContents();
				...
				c.attachListener(c, "keydown", function (a) {
					function c(b, e) {
						...
						var l = a.createRange(), g = CKEDITOR.dom.range.mergeRanges(e);
						CKEDITOR.tools.array.forEach(g, function (a) {
							a.enlarge(CKEDITOR.ENLARGE_ELEMENT)
						});
						var m = g[0].getBoundaryNodes(), n = m.startNode, m = m.endNode;
						if (n && n.is && n.is(h)) {
							for (var q = n.getAscendant("table", !0), u = n.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT, q), r = !1, t = function (a) {
								return !n.contains(a) && a.is && a.is("td", "th")
							     ...
							     !t(u);) u = u.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT, q);
							!u && m && m.is && !m.is("table") && m.getNext() && (u = m.getNext().findOne("td, th"), r = !0);
							if (u) l["moveToElementEdit" + (r ? "Start" : "End")](u); else l.setStartBefore(n.getAscendant("table", !0)), l.collapse(!0);
							g[0].deleteContents();
							return [l]
						}
					...
					var g = {37: 1, 38: 1, 39: 1, 40: 1, 8: 1, 46: 1, 13: 1},
						h = CKEDITOR.tools.extend({table: 1}, CKEDITOR.dtd.$tableContent);
					delete h.td;
					delete h.th;
					return function (k) {
						var f = k.data.getKey(),
							l = k.data.getKeystroke(), h, m = 37 === f || 38 == f, n, q, r;
						if (g[f] && (h = a.getSelection()) && h.isInTable() && h.isFake) {
							n = h.getRanges();
							q = n[0]._getTableElement();
							r = n[n.length - 1]._getTableElement();
							if (13 !== f || a.plugins.enterkey) k.data.preventDefault(), k.cancel();
							if (36 < f && 41 > f) n[0].moveToElementEditablePosition(m ? q : r, !m), h.selectRanges([n[0]]); else if (13 !== f || 13 === l || l === CKEDITOR.SHIFT + 13) {
				...
				c.attachListener(c, "keypress", function (d) {
					var c = a.getSelection(), g = d.data.$.charCode || 13 === d.data.getKey(), h;
					if (c && c.isInTable() && c.isFake && g && !(d.data.getKeystroke() & CKEDITOR.CTRL)) {
						d = c.getRanges();
						g = d[0].getEnclosedNode().getAscendant({td: 1, th: 1}, !0);
						for (h = 0; h < d.length; h++) b(d[h]);
						g && (d[0].moveToElementEditablePosition(g),
							c.selectRanges([d[0]]))
					}
				}, null, null, -1)
		...
		CKEDITOR.plugins.add("tableselection", {
			requires: "clipboard,tabletools", onLoad: function () {
				...
				CKEDITOR.plugins.tableselection.isSupportedEnvironment && (a.addContentsCss && a.addContentsCss(this.path + "styles/tableselection.css"),
					...
					}), a.on("paste", H.onPaste,
					H), B(a, "rowInsertBefore rowInsertAfter columnInsertBefore columnInsertAfter cellInsertBefore cellInsertAfter".split(" "), function (a, c) {
					t(a, c.selectedCells)
	...
	(function () {
				...
				CKEDITOR.tools.extend(a,
					{
						...
						}), locator: new c.locator(b), liner: new c.liner(b, {
							lineStyle: {
		...
		function B(a, b) {
			...
			if (!d.getById("cke_copybin")) {
				...
				e.setStyles({position: "absolute", width: "1px", height: "1px", overflow: "hidden"});
		...
		g.prototype = {
			addClass: function (a) {
				...
				var a =
						this.editor, b = this.element.$, c = this._.dragHandlerOffset,
		...
		var X = /^(?:<(?:div|span)(?: data-cke-temp="1")?(?: id="cke_copybin")?(?: data-cke-temp="1")?>)?(?:<(?:div|span)(?: style="[^"]+")?>)?<span [^>]*data-cke-copybin-start="1"[^>]*>.?<\/span>([\s\S]+)<span [^>]*data-cke-copybin-end="1"[^>]*>.?<\/span>(?:<\/(?:div|span)>)?(?:<\/(?:div|span)>)?$/i,
			ga = {37: 1, 38: 1, 39: 1, 40: 1, 8: 1, 46: 1};
		...
		e.prototype = {
			...
			_updateNotification: function () {
				...
				var a = this.getTaskCount(),
					b = {current: this.getDoneTaskCount(), max: a, percentage: Math.round(100 * this.getPercentage())};
				...
				-1 !== b && (a._doneWeight && (this._doneWeights -= a._doneWeight), this._totalWeights -= a._weight, this._tasks.splice(b, 1), this.update())
	...
	(function () {
		...
		CKEDITOR.tools.extend(CKEDITOR.fileTools, {
			addUploadWidget: function (a, c, f) {
				var h = CKEDITOR.fileTools, b = a.uploadRepository, m = f.supportedTypes ? 10 : 20;
				if (f.fileToElement) a.on("paste", function (d) {
					d = d.data;
					var l = a.widgets.registered[c], k = d.dataTransfer, f = k.getFilesCount(), g = l.loadMethod ||
						"loadAndUpload", e, n;
					if (!d.dataValue && f) for (n = 0; n < f; n++) if (e = k.getFile(n), !l.supportedTypes || h.isTypeSupported(e, l.supportedTypes)) {
				...
				CKEDITOR.tools.extend(f, {
					...
					init: function () {
						var d = this, c = this.wrapper.findOne("[data-cke-upload-id]").data("cke-upload-id"),
							k = b.loaders[c], f = CKEDITOR.tools.capitalize, g, e;
						k.on("update", function (b) {
							if (d.wrapper && d.wrapper.getParent()) {
								a.fire("lockSnapshot");
								b = "on" + f(k.status);
								if ("function" !== typeof d[b] || !1 !== d[b](k)) e = "cke_upload_" + k.status, d.wrapper && e != g && (g && d.wrapper.removeClass(g), d.wrapper.addClass(e), g = e), "error" != k.status && "abort" != k.status || a.widgets.del(d);
								a.fire("unlockSnapshot")
							} else CKEDITOR.instances[a.name] &&
						...
						if ("" === d.trim()) a.widgets.del(this); else {
							var b = this == a.widgets.focused, f = a.editable(), g = a.createRange(), e, h;
				...
				a.setAttributes({"data-cke-upload-id": f, "data-widget": c})
			}, bindNotifications: function (a, c) {
				function f() {
					h = a._.uploadWidgetNotificaionAggregator;
					if (!h || h.isFinished()) h = a._.uploadWidgetNotificaionAggregator = new CKEDITOR.plugins.notificationAggregator(a, a.lang.uploadwidget.uploadMany, a.lang.uploadwidget.uploadOne),
			...
			requires: "uploadwidget", onLoad: function () {
				...
				if (CKEDITOR.plugins.clipboard.isFileApiSupported) {
					...
					e && (a.addUploadWidget(c, "uploadimage", {
						supportedTypes: /image\/(jpeg|png|gif|bmp)/, uploadUrl: e, fileToElement: function () {
							...
							return b
						}, parts: {img: "img"}, onUploading: function (b) {
						...
						if (b.data.dataValue.match(/<img[\s\S]+data:/i)) {
							...
							var f = document.implementation.createHTMLDocument(""),
								f = new CKEDITOR.dom.element(f.body), m, g, k;
							f.data("cke-editable", 1);
							f.appendHtml(b.dataValue);
							m = f.find("img");
							for (k = 0; k < m.count(); k++) {
								g = m.getItem(k);
								var d = g.getAttribute("src"), h = d && "data:" == d.substring(0, 5),
									l = null === g.data("cke-realelement");
								h && l && !g.data("cke-upload-id") && !g.isReadOnly(1) &&
